...
class ActorRolloutRefWorker(Worker):
    ...
    def init_model(self):
        from verl.workers.actor import DataParallelPPOActorExplore
        ...
        if self._is_actor:
            ...
            self.actor = DataParallelPPOActorExplore(config=self.config.actor,
        ...
        if self._is_ref:
            ...
            self.ref_policy = DataParallelPPOActorExplore(config=self.config.ref, actor_module=self.ref_module_fsdp)
...
class CriticWorker(Worker):
    ...
    def init_model(self):
        ...
        from verl.workers.critic import DataParallelPPOCriticExplore
        ...
        self.critic = DataParallelPPOCriticExplore(config=self.config,
