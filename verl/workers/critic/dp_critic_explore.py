...
class DataParallelPPOCriticExplore(BasePPOCritic):
    ...
    def update_critic(self, data: DataProto):
        ...
        select_keys = ['attention_mask', 'input_ids', 'old_log_probs', 'responses', 'token_level_rewards', 'avg_reward', 'position_ids', 'ref_log_prob']
        batch = data.select(batch_keys=select_keys).batch
