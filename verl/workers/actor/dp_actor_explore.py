...
__all__ = ['DataParallelPPOActorExplore']


class DataParallelPPOActorExplore(BasePPOActor):
    ...
    def __init__(
        ...
        # assert only one is True
        assert (self.config.normalize_logprob + self.config.conservative + self.config.normalize_by_pi_ref) <= 1
    ...
    def update_policy(self, data: DataProto):
        ...
        select_keys = ['attention_mask', 'input_ids', 'responses', 'token_level_rewards', 'avg_reward', 'position_ids', 'old_log_probs', 'ref_log_prob', 'v_star']
        ...
        for batch_idx, data in enumerate(dataloader):
            ...
            for data in micro_batches:
                ...
                pg_loss = core_algos.compute_policy_loss_explore(gvalues=values,
                                                                 ...
                                                                 normalize_by_pi_ref=self.config.normalize_by_pi_ref,)
