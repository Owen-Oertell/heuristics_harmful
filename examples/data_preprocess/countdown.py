...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dir', default='/n/holylabs/LABS/kdbrantley_lab/Lab/zhaolin/reasoning/data/countdown')
    ...
    parser.add_argument('--train_size', type=int, default=81920)
